...
- **Allows you to add different items to your collection**
- **The collection can contain books, music albums and games**
- **Each item has a label, an author and a genre**
- **You can list all items of one category as well as all labels, authors or genres**
...
```sh
$  git clone git@github.com:lucascomamala/catalog-of-my-things.git
```
